...
class ProductDetail extends Component {
    ...
    render() {
        ...
        return (
            <div className="float-product">
                <h2 className="text-product"> PRODUCT DETAIL </h2>
                <form>
                    <table>
                        <tbody>
                            <tr class="input-box1">
                            ...
                            <tr class="input-box1">
                                <td></td>
                                <td>
                                    <input type="submit" class="btn" value="ADD NEW" onClick={(e) => this.btnAddClick(e)} />
                                    <input type="submit" class="btn" value="UPDATE" onClick={(e) => this.btnUpdateClick(e)} />
                                    <input type="submit" class="btn" value="DELETE" onClick={(e) => this.btnDeleteClick(e)} />
                                </td>
                            </tr>
                            <tr>
                                <td colSpan="2">
